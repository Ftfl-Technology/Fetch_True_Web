...
import { useTrendingCategoryProviders } from "@/src/context/TrendingCategoryProviderContext";
...
export default function TopTrending({ selectedRange, selectedCategory, searchQuery = "", contextTitle, moduleId, categoryId }: SectionProps) {
    ...
    useEffect(() => {
        if (moduleId && categoryId) {
            fetchTrendingProviders(categoryId,20.175618471885596,72.73285952405311);
        }
    }, [moduleId, categoryId]);
    ...
    return (
        <div className="relative w-full mt-6  lg:mt-2">
            <h1 className="text-[16px] font-semibold lg:text-[24px] ml-4 lg:ml-12">Top Trending Provider</h1>
            {/* SCROLL CONTAINER */}
            <div
                ref={scrollRef}
                            ...
                            <div className="-mx-4 -mt-4 lg:-mt-4 p-4 max-h-[150px] bg-[#F7FAFE] rounded-t-xl">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        {/* <div className="text-[10px] lg:text-[14px] text-gray-600 mt-1 lg:whitespace-nowrap md:whitespace-normal">
                                            <FaMapMarkerAlt className="w-3 h-3 lg:w-4 lg:h-4 text-blue-500 inline mr-1" /> 
                                    ...
                                    <Bookmark className="w-4 h-4 lg:w-5 lg:h-5 text-gray-400 shrink-0 mt-1 md:-ml-15 lg:-ml-6" />
                                </div>
                            </div>
                            ...
                            <div className="hidden md:block mt-4">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <div>
                                            <p className="md:text-[10px] lg:text-[13px] font-medium">{item.rating} Rating</p>
                                            <p className="md:text-[10px] lg:text-[12px] text-gray-500">{item.reviews} Reviews</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
