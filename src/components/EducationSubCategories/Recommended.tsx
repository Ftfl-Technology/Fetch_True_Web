...
export default function Recommendation({ categoryId, moduleId, sortBy }: Props) {
    const {
        services,
        loading,
        error,
                    ...
                    sortedServices.map((item) => (
                        ...
                        >
                            ...
                            <div className="relative z-10 md:h-[362px] lg:h-[361px] bg-[#FFFFFF] border border-gray-300 rounded-xl flex flex-col">
                                {/* IMAGE SECTION */}
                                <div className="relative md:h-[170px] w-full p-3 h-[156px]">
                                    <img
                                        src={item.image}
                                        alt={item.title}
                                ...
                                <div className="relative p-2 lg:-mt-4 md:-mt-8 -mt-4 text-black flex flex-col h-full">
                                    ...
                                    <div className="flex items-center justify-between mb-2 md:mb-6">
                                        <span className="inline-block font-semibold text-[12px] md:text-[16px] px-3 py-1 md:mt-4 lg:mt-0 mt-0
                                         leading-snug
                                        line-clamp-2 max-w-[65%]
                                        min-h-[40px] lg:min-h-[40px]">
                                            {item.title}
                                    ...
                                    <div className="flex items-cente mb-2">
                                        <div className="inline-flex items-center gap-6 text-[9px] md:text-[12px] px-3 py-1 whitespace-nowrap shrink-0">
                                            ...
                                            {item.keyValues.map((kv) => (
                                                <span
                                                    key={kv.id}
                                                    className="text-[11px] text-gray-700 leading-snug -ml-1"
                                                >
                                                    {kv.label}
                                                </span>
                                            ))}
